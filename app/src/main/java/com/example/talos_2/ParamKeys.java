...
import com.example.talos_2.param.ParameterInfo;
import com.example.talos_2.param.ParameterLevel;

public enum ParamKeys implements ParameterInfo {
    PARAM_GPS_SPEED_CHANGE_DAMPER("com.example.talos_2.gps.speedChangeDamper",
                                  "Speed change damper",
        ...
        PARAM_GPS_MIN_DISTANCE("com.example.talos_2.gps.minDistance",
                               "min distance",
        ...
        PARAM_GPS_DATA_FILTER_MAX_SPEED("com.example.talos_2.gps.maxSpeed",
                                        "max speed",
                                        "Maximum permited boat speed - useful for catching and throwing away erratic GPS readings",
                                        "GPS",
                                        ParameterLevel.ADVANCED, 6.5f),
                        
            PARAM_SENSOR_ORIENTATION_CHANGE_DAMP_FACTOR("com.example.talos_2.sensor.orientationChangeDampFactor",
                                                 "orientation damper", 
                                                 "Lowpass filter used as stabalizer for the 'down' notion of the application", 
                                                 "Sensors", 
                                                 ParameterLevel.ADVANCED, 0.01f),
        
            PARAM_SENSOR_ORIENTATION_LANDSCAPE("com.example.talos_2.sensor.orientationLandscape",
                                               "session recording on", "", "{internal}", ParameterLevel.PRIVATE, false),
                                        
            PARAM_SENSOR_ORIENTATION_REVERSED("com.example.talos_2.sensor.reverseDeviceOrientation",
                                              "coax mode", 
            ...
            PARAM_STROKE_RATE_AMPLITUDE_FILTER_FACTOR("com.example.talos_2.stroke.rate.amplitudeFilterFactor",
            ...
            PARAM_STROKE_RATE_AMPLITUDE_CHANGE_DAMPER_FACTOR("com.example.talos_2.stroke.rate.amplitudeChangeDamperFactor",
            ...
            PARAM_STROKE_RATE_MIN_AMPLITUDE("com.example.talos_2.stroke.rate.minAmplitude",
            ...
            PARAM_STROKE_RATE_AMPLITUDE_CHANGE_ACCEPT_FACTOR("com.example.talos_2.stroke.rate.amplitudeChangeAcceptFactor",
           ...
           PARAM_STROKE_RATE_RATE_CHANGE_ACCEPT_FACTOR("com.example.talos_2.stroke.rate.rateChangeAcceptFactor",
            ...
            PARAM_STROKE_POWER_AMPLITUDE_FILTER_FACTOR("com.example.talos_2.stroke.power.amplitudeFilterFactor",
                                                       "power filter",
                                                       "*FIXME*", // FIXME
                                                       "Stroke Power", 
                                                       ParameterLevel.ADVANCED, .5f),
                        
            PARAM_STROKE_POWER_MIN_POWER("com.example.talos_2.stroke.power.minPower",
                                         "power filter",
                                         "Minimum power (sum of acceleration points) required during a rowing cycle in order for it to register",
                                         "Stroke Power", 
                                         ParameterLevel.ADVANCED, 5f),
                        
            PARAM_ROWING_STOP_TIMEOUT("com.example.talos_2.stroke.detector.stopTimeout",
                                      "stop timeout", 
                                      "How many seconds since end of last stroke before finishing a rowing lap when in 'Autorow' mode", 
                                      "Autorow", 
                                      ParameterLevel.BASIC, 5),       
                        
            PARAM_ROWING_START_AMPLITUDE_TRESHOLD("com.example.talos_2.stroke.detector.minAmplitude",
                                                  "min amplitude", 
            ...
            PARAM_ROWING_RESTART_WAIT_TIME("com.example.talos_2.stroke.detector.restartWaitTime",
            ...
            PARAM_ROWING_MODE("com.example.talos_2.stroke.detector.startMode",
            ...
            PARAM_ROWING_STRAIGHT_LINE_MODE("com.example.talos_2.stroke.detector.straightLineMode",
            ...
            PARAM_SESSION_RECORDING_ON("com.example.talos_2.android.sessionRecordingOn",
                                       "session recording on", "", "{internal}", ParameterLevel.PRIVATE, false),
                                                                
            PARAM_SESSION_RECORDING_LEADER_ENABLE("com.example.talos_2.android.record.leader.enable",
            ...
            PARAM_SESSION_BROADCAST_ON("com.example.talos_2.session.broadcast.on",
                                       "session broadcast on", 
                                       "Activate broadcasting Talos sensor data, events to a remote Talos device", 
                                       "Session",
                                       ParameterLevel.BASIC, false),
                                        
            PARAM_SESSION_BROADCAST_PORT("com.example.talos_2.session.broadcast.port",
            ...
            PARAM_SESSION_BROADCAST_HOST("com.example.talos_2.session.broadcast.host",
