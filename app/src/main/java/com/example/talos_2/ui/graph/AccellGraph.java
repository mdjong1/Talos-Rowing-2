...
public class AccellGraph extends SensorGraphBase  {
	...
	private class RollGraphOverlay implements SensorDataSink {
		...
		void drawRollPanels(com.example.talos_2.ui.RSCanvas canvas, RSRect rect, double xAxisSize) {
	...
	public AccellGraph(com.example.talos_2.ui.UILiaison factory, float xRange, RoboStroke roboStroke) {
