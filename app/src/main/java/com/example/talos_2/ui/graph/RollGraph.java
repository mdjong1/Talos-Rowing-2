...
public class RollGraph extends LineGraph implements SensorDataSink {
	...
	public RollGraph(com.example.talos_2.ui.UILiaison uiLiaison, final double xRange) {
	...
	private void drawRollPanels(com.example.talos_2.ui.RSCanvas canvas, RSRect rect, double xAxisSize) {
