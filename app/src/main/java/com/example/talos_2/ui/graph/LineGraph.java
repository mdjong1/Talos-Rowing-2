...
import com.example.talos_2.common.NumberHelper;
import com.example.talos_2.ui.RSCanvas;
import com.example.talos_2.ui.RSPaint;
import com.example.talos_2.ui.RSPath;
...
public class LineGraph implements UpdatableGraphBase {
	...
	protected final com.example.talos_2.ui.UILiaison uiLiaison;
	...
	public LineGraph(final com.example.talos_2.ui.UILiaison uiLiaison, double xRange, XYSeries.XMode xMode, double yScale,
	 ...
	 *            y data tic mark gap
	 */
	public LineGraph(com.example.talos_2.ui.UILiaison uiLiaison, double yRange,
	...
	public com.example.talos_2.ui.UILiaison getUiLiaison() {
		return uiLiaison;
	}
	
	@Override
	public void draw(com.example.talos_2.ui.RSCanvas canvas) {
	...
	protected void drawGraph(com.example.talos_2.ui.RSCanvas canvas, RSRect rect, double xAxisSize,
                             double yAxisSize) {
	...
	private void drawAllSeries(com.example.talos_2.ui.RSCanvas canvas, RSRect rect, double xAxisSize,
                               double yAxisSize) {
	...
	protected void drawSeries(com.example.talos_2.ui.RSCanvas canvas, RSRect rect, double xAxisSize,
	...
	protected void drawGrid(com.example.talos_2.ui.RSCanvas canvas, double yAxisSize, RSRect rect) {
		float y;
	...
	protected void drawLine(com.example.talos_2.ui.RSCanvas canvas, double yAxisSize, RSRect rect) {
		float y;
		final int top = rect.top;
		final int height = rect.height();
	...
	protected void drawCentreLine(com.example.talos_2.ui.RSCanvas canvas, RSRect rect) {
