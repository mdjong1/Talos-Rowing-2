...
import com.example.talos_2.common.ClockTime;
...
import com.example.talos_2.stroke.RowingSplitMode;
import com.example.talos_2.ui.RSClickListener;
import com.example.talos_2.ui.RSLongClickListener;
...
public class MetersDisplayManager implements SensorDataSink {
	...
	public MetersDisplayManager(RoboStroke rs, final MeterView meters) {
		...
		meters.getSplitTimeTxt().setOnClickListener(new com.example.talos_2.ui.RSClickListener() {
	...
	private void highlightTimeMeter(int[] color) {
		com.example.talos_2.ui.RSView highlightBar = meters.getStrokeModeHighlighter();
