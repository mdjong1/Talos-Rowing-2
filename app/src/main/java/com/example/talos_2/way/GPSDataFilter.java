...
package com.example.talos_2.way;
...
public class GPSDataFilter implements SensorDataSink, ParameterListenerOwner {
	...
	private final com.example.talos_2.RoboStrokeEventBus bus;
	...
	private com.example.talos_2.RoboStroke owner;
	...
	public GPSDataFilter(com.example.talos_2.RoboStroke owner, final DistanceResolver distanceResolver) {
		this.owner = owner;
		...
		speedChangeDamperFilter = new LowpassFilter((Float)params.getValue(com.example.talos_2.ParamKeys.PARAM_GPS_SPEED_CHANGE_DAMPER.getId()));
		
		straightLineModeOn = (Boolean)params.getValue(com.example.talos_2.ParamKeys.PARAM_ROWING_STRAIGHT_LINE_MODE.getId());
		
		minDistance = (Integer)params.getValue(com.example.talos_2.ParamKeys.PARAM_GPS_MIN_DISTANCE.getId());
		
		maxSpeed = (Float)params.getValue(com.example.talos_2.ParamKeys.PARAM_GPS_DATA_FILTER_MAX_SPEED.getId());
	...
	private final ParameterListenerRegistration[] listenerRegistrations = {
			new ParameterListenerRegistration(com.example.talos_2.ParamKeys.PARAM_GPS_SPEED_CHANGE_DAMPER.getId(), new ParameterChangeListener() {
			...
			new ParameterListenerRegistration(com.example.talos_2.ParamKeys.PARAM_GPS_MIN_DISTANCE.getId(), new ParameterChangeListener() {
			...
			new ParameterListenerRegistration(com.example.talos_2.ParamKeys.PARAM_GPS_DATA_FILTER_MAX_SPEED.getId(), new ParameterChangeListener() {
			...
			new ParameterListenerRegistration(com.example.talos_2.ParamKeys.PARAM_ROWING_STRAIGHT_LINE_MODE.getId(), new ParameterChangeListener() {
