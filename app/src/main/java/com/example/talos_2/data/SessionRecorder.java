...
public class SessionRecorder extends com.example.talos_2.SensorBinder implements SessionRecorderConstants {
	
	private ErrorListener errorListener;
	private BufferedWriter logger;
	private boolean initialized;
	
	public SessionRecorder(com.example.talos_2.RoboStroke roboStroke) {
		super(roboStroke);
	}
