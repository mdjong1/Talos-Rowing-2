...
import com.example.talos_2.SensorBinder;
import com.example.talos_2.data.DataRecord;
import com.example.talos_2.data.remote.DataRemote.DataRemoteError;

public class SessionBroadcaster extends com.example.talos_2.SensorBinder {
					
	private final DataSender dataSender;
	
	private boolean broadcast;
	
	public SessionBroadcaster(com.example.talos_2.RoboStroke roboStroke) throws DataRemoteError {
		this(roboStroke, null);
	}
	
	public SessionBroadcaster(com.example.talos_2.RoboStroke roboStroke, DataSender dataTransport) throws DataRemoteError {
