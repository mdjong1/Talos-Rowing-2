 ...
 */
package com.example.talos_2.acceleration;
...
public class AccelerationFilter extends SensorDataFilter implements ParameterListenerOwner {
	...
	public AccelerationFilter(com.example.talos_2.RoboStroke owner) {
		this.params = owner.getParameters();
		
		accelMode = (Boolean)params.getValue(com.example.talos_2.ParamKeys.PARAM_SENSOR_ORIENTATION_REVERSED.getId()) ? COAX_MODE : ROWER_MODE;
	...
	private final ParameterListenerRegistration[] listenerRegistrations = {
			new ParameterListenerRegistration(com.example.talos_2.ParamKeys.PARAM_SENSOR_ORIENTATION_REVERSED.getId(), new ParameterChangeListener() {
