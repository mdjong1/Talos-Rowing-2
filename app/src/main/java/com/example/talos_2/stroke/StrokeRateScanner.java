...
public class StrokeRateScanner extends StrokeScannerBase implements ParameterListenerOwner {
	...
	private final ParameterListenerRegistration[] listenerRegistrations = {
			new ParameterListenerRegistration(com.example.talos_2.ParamKeys.PARAM_STROKE_RATE_AMPLITUDE_FILTER_FACTOR.getId(), new ParameterChangeListener() {
			...
			new ParameterListenerRegistration(com.example.talos_2.ParamKeys.PARAM_STROKE_RATE_MIN_AMPLITUDE.getId(), new ParameterChangeListener() {
			...
			new ParameterListenerRegistration(com.example.talos_2.ParamKeys.PARAM_STROKE_RATE_AMPLITUDE_CHANGE_DAMPER_FACTOR.getId(), new ParameterChangeListener() {
			...
			new ParameterListenerRegistration(com.example.talos_2.ParamKeys.PARAM_STROKE_RATE_AMPLITUDE_CHANGE_ACCEPT_FACTOR.getId(), new ParameterChangeListener() {
	...
	public StrokeRateScanner(com.example.talos_2.RoboStroke owner) {
		super(owner.getBus(), (Float) owner.getParameters().getValue(com.example.talos_2.ParamKeys.PARAM_STROKE_RATE_AMPLITUDE_FILTER_FACTOR.getId()));
