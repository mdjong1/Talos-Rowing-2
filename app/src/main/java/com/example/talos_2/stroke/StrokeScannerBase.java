...
import com.example.talos_2.stroke.HalfSinoidDetector.Dir;
...
public abstract class StrokeScannerBase  extends SensorDataFilter {
	...
	protected final com.example.talos_2.RoboStrokeEventBus bus;
	

	public StrokeScannerBase(com.example.talos_2.RoboStrokeEventBus bus, float amplitudeFilterFactor) {
		this.bus = bus;
