...
public class RowingDetector implements SensorDataSink, ParameterListenerOwner {
    ...
    private final ParameterListenerRegistration[] listenerRegistrations = {
        ...
        new ParameterListenerRegistration(com.example.talos_2.ParamKeys.PARAM_ROWING_STOP_TIMEOUT.getId(), new ParameterChangeListener() {
        ...
        new ParameterListenerRegistration(com.example.talos_2.ParamKeys.PARAM_ROWING_RESTART_WAIT_TIME.getId(), new ParameterChangeListener() {
        ...
        new ParameterListenerRegistration(com.example.talos_2.ParamKeys.PARAM_ROWING_MODE.getId(), new ParameterChangeListener() {
        ...
        new ParameterListenerRegistration(com.example.talos_2.ParamKeys.PARAM_ROWING_START_AMPLITUDE_TRESHOLD.getId(), new ParameterChangeListener() {
			...
			new ParameterListenerRegistration(com.example.talos_2.ParamKeys.PARAM_STROKE_RATE_RATE_CHANGE_ACCEPT_FACTOR.getId(), new ParameterChangeListener() {
    ...
    public RowingDetector(RoboStroke roboStroke) {
        ...
        rowingMode = RowingSplitMode.valueOf((String) params.getValue(com.example.talos_2.ParamKeys.PARAM_ROWING_MODE.getId()));
                
        paramStopTimeout = TimeUnit.SECONDS.toNanos((Integer) params.getValue(com.example.talos_2.ParamKeys.PARAM_ROWING_STOP_TIMEOUT.getId()));

        paramStartMinAmplitude = (Float)params.getValue(com.example.talos_2.ParamKeys.PARAM_ROWING_START_AMPLITUDE_TRESHOLD.getId());

        paramRestartWaitTime = TimeUnit.SECONDS.toNanos((Integer) params.getValue(com.example.talos_2.ParamKeys.PARAM_ROWING_RESTART_WAIT_TIME.getId()));

		rateChangeAcceptFactor = (Float) params.getValue(com.example.talos_2.ParamKeys.PARAM_STROKE_RATE_RATE_CHANGE_ACCEPT_FACTOR.getId());

		bus = roboStroke.getBus();
                
        bus.addBusListener(new com.example.talos_2.BusEventListener() {
