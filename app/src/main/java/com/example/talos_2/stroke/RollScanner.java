 ...
 *
 */
public class RollScanner extends SensorDataFilter implements com.example.talos_2.BusEventListener {
	...
	public RollScanner(com.example.talos_2.RoboStrokeEventBus bus) {
		this.bus = bus;
