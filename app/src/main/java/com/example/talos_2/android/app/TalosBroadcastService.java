...
import com.example.talos_2.data.remote.DatagramDataSender;
...
public class TalosBroadcastService extends TalosService {
	...
	private static final Logger logger = LoggerFactory.getLogger(TalosBroadcastService.class);
