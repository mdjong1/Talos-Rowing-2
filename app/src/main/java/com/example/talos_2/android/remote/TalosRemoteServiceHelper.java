...
import com.example.talos_2.android.app.R;
...
class TalosRemoteServiceHelper {
	...
	final static String BROADCAST_SERVICE_ID = "com.example.talos_2.android.remote.TalosBroadcastService";
	final static String RECEIVER_SERVICE_ID = "com.example.talos_2.android.remote.TalosReceiverService";
	
	private final static Map<String, Pair<String, String>> serviceClassMap = new HashMap<String, Pair<String, String>>();
	
	static {
		serviceClassMap.put(BROADCAST_SERVICE_ID, Pair.create("com.example.talos_2.android.remote", "com.example.talos_2.android.remote.TalosBroadcastService"));
		serviceClassMap.put(RECEIVER_SERVICE_ID, Pair.create("com.example.talos_2.android.remote", "com.example.talos_2.android.remote.TalosReceiverService"));
	}
