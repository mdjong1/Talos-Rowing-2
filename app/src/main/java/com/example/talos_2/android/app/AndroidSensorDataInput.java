...
import com.example.talos_2.data.SensorDataInputBase;
...
public class AndroidSensorDataInput extends SensorDataInputBase {
	...
	private int getSensorDelay(RoboStrokeActivity owner) {
		...
		int sensorDealyMillis = Integer.valueOf(owner.preferencesHelper.getPref("com.example.talos_2.android.sensor.sensorUpdateDelay", SENSOR_DELAY + ""));
