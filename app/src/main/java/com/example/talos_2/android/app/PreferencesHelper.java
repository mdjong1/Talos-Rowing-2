...
public class PreferencesHelper {
	...
	public static final String PREFERENCE_KEY_HRM_ENABLE = "com.example.talos_2.android.hrm.enable";

	public static final String PREFERENCE_KEY_PREFERENCES_RESET = "com.example.talos_2.android.preferences.reset";
	
	public static final String PREFERENCE_KEY_PREFERENCES_LOG = "com.example.talos_2.android.preferences.log";
	
	public static final String METERS_RESET_ON_START_PREFERENCE_KEY = "com.example.talos_2.android.stroke.detector.resetOnStart";

	public static final String GRAPHS_SHOW_PREFERENCE_KEY = "com.example.talos_2.android.layout.graphs.show";

	public static final String METERS_LAYOUT_MODE_KEY = "com.example.talos_2.android.layout.meters.layoutMode";

	public static final String PREFERENCE_KEY_LAYOUT_MODE_LANDSCAPE = "com.example.talos_2.android.layout.mode.landscape";
	...
	private void setParameterFromPreferences(String key) {
		if (key.startsWith("com.example.talos_2") && !key.startsWith("com.example.talos_2.android")) {
