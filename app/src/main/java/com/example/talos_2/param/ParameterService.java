 ...
 */
package com.example.talos_2.param;
...
public class ParameterService {
	...
	private final com.example.talos_2.RoboStrokeEventBus eventBus;
	...
	public ParameterService(com.example.talos_2.RoboStrokeEventBus bus) {
		this.eventBus = bus;
		 ...
		 */
		eventBus.addBusListener(new com.example.talos_2.BusEventListener() {
