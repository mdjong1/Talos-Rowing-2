...
public abstract class SensorBinder implements com.example.talos_2.BusEventListener {
	...
	private class SensorDataSourceBinder implements SensorDataSink {
		...
		public void onSensorData(long timestamp, Object data) {
			...
			com.example.talos_2.SensorBinder.this.onSensorData(DataRecord.create(type, timestamp, data));
		}
